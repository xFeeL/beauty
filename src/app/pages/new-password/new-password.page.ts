...
export class NewPasswordPage implements OnInit {
  ...
  newPassword() {
    ...
    if (this.token != null) {
      ...
      this.signup_user.email = this.signUpForm.email;
      this.signup_user.phone = this.signUpForm.phone;
      this.signup_user.app = "beauty"
      this.userService.setNavData({ phone: this.signUpForm.phone, emai: this.signup_user.email, password: this.the_password, authType: "ordinary" });
